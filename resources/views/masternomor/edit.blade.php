       ...
       <div class="card-body">
          <div class="employee-info">
            ...
            @endif
             ...
             <form action="{{ route('masternomor.update', $nomor->idnomor) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="form-label" for="nomor_induk">Nomor Induk Yayasan:<span style="color: red;">*</span></label>
                        <input type="text" class="form-control" name="nomor_yayasan" placeholder="Nomor Induk Yayasan" value="{{ $nomor->nomor_yayasan }}" required>
                     </div>
                </div>
